...
function NextMeetingBanner({
  ...
  return (
    <motion.div
      ...
      className="mb-6"
    >
      <div className="relative bg-muted/50 dark:bg-muted/30 border border-border rounded-lg p-4 overflow-hidden">
        {/* Subtle pulse effect */}
        <div
        ...
        <div className="relative flex items-center gap-4">
          {/* Meeting Icon */}
          <div className="w-12 h-12 rounded-[7px] bg-foreground/5 dark:bg-foreground/10 flex items-center justify-center shrink-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              onClick={onViewBrief}
              className="px-3 py-2 text-xs font-medium text-foreground/70 hover:bg-foreground/5 rounded-[7px] transition-colors"
            >
              View Brief
            </button>
            <button
              onClick={onJoin}
              className="px-4 py-2 text-xs font-medium bg-foreground hover:bg-foreground/90 text-background rounded-[7px] transition-colors"
            >
              Join Now
            </button>
            <button
              onClick={onDismiss}
              className="p-2 text-muted-foreground hover:text-muted-foreground dark:hover:text-foreground hover:bg-muted dark:hover:bg-neutral-800 rounded-[7px] transition-colors"
              aria-label="Dismiss"
            >
              <X className="w-4 h-4" />
            </button>
...
function MoreIndicator({
  ...
  return (
    <motion.button
      ...
      animate={{ opacity: 1 }}
      onClick={onToggle}
      className="w-full mt-4 py-3 flex items-center justify-center gap-2 text-xs font-medium text-muted-foreground hover:text-muted-foreground transition-colors group"
    >
      <span>
        {isExpanded
          ? "Show less"
    ...
    switch (actionId) {
      ...
      case "intervened":
        ...
        toast.success("Action logged", {
          description:
            "Intervention recorded. Will resurface if external signals indicate unresolved.",
          duration: 3000,
        });
        setFocusedItem(null);
        break;
          ...
          switch (sourceType) {
            ...
            case "contacts":
              ...
              toast.info("Opening CRM", {
                description: "Navigating to contact details...",
                duration: 2000,
              });
              break;
            case "email":
              ...
              toast.info("Opening Email", {
                description: "Navigating to email thread...",
                duration: 2000,
              });
              break;
            case "slack":
              // Would open Slack or show thread
              toast.info("Opening Slack", {
                description: "Navigating to Slack thread...",
                duration: 2000,
              });
              break;
            case "linear":
              // Would open Linear
              toast.info("Opening Linear", {
                description: "Navigating to Linear issue...",
                duration: 2000,
              });
              break;
            case "notion":
              ...
              toast.info("Opening Notion", {
                description: "Navigating to Notion page...",
                duration: 2000,
              });
              break;
            default:
