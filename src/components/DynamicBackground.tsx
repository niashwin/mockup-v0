...
> = {
  ...
  night: {
    primary: "from-slate-100 via-neutral-100 to-neutral-100",
    secondary: "from-slate-200/30 to-neutral-200/30",
...
> = {
  morning: {
    primary:
      "dark:from-amber-950/30 dark:via-orange-950/20 dark:to-neutral-950",
    secondary: "dark:from-amber-900/10 dark:to-orange-900/10",
    accent: "dark:bg-amber-800/10",
  },
  day: {
    primary: "dark:from-blue-950/30 dark:via-sky-950/20 dark:to-neutral-950",
    secondary: "dark:from-blue-900/10 dark:to-sky-900/10",
    accent: "dark:bg-blue-800/10",
  },
  evening: {
    primary:
      "dark:from-violet-950/30 dark:via-purple-950/20 dark:to-neutral-950",
    secondary: "dark:from-violet-900/10 dark:to-purple-900/10",
    accent: "dark:bg-violet-800/10",
  },
  night: {
    primary: "dark:from-neutral-950 dark:via-neutral-950 dark:to-neutral-950",
    secondary: "dark:from-neutral-900/10 dark:to-neutral-900/10",
    accent: "dark:bg-neutral-800/10",
  },
};
...
export const DynamicBackground: React.FC<DynamicBackgroundProps> = ({
  ...
  return (
    <div className={`relative flex flex-col ${className}`}>
      ...
      {/* Decorative elements — subtle ambient glow, not dominant */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className={`absolute -top-[15%] -right-[10%] w-[30%] h-[30%] rounded-full ${gradient.accent} ${darkGradient.accent} blur-3xl`}
        />
        ...
        <motion.div
          ...
          className={`absolute -bottom-[10%] -left-[10%] w-[25%] h-[25%] rounded-full ${gradient.accent} ${darkGradient.accent} blur-3xl`}
        />
      </div>
