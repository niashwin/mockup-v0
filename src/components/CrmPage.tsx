...
const DEAL_STAGE_CONFIG: Record<DealStage, { label: string; color: string }> = {
  lead: { label: "Lead", color: "bg-secondary text-muted-foreground" },
...
const CompanyCard: React.FC<{
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -10 }}
      onClick={onClick}
      className="bg-card border border-border rounded-[7px] p-4 hover:shadow-lg hover:border-border transition-all cursor-pointer group"
    >
      {/* Header */}
      <div className="flex items-start gap-3 mb-3">
        <div className="w-10 h-10 rounded-[7px] bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-600 flex items-center justify-center shrink-0">
...
const CompanyDrawer: React.FC<{
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 bottom-0 w-full max-w-lg bg-card border-l border-border shadow-2xl z-50 flex flex-col"
    >
      {/* Header */}
      <div className="p-5 border-b border-border">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 w-8 h-8 rounded-full bg-muted dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 flex items-center justify-center text-muted-foreground transition-colors"
        >
          <X size={16} />
        </button>

        <div className="flex items-start gap-4">
          <div className="w-14 h-14 rounded-[7px] bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-600 flex items-center justify-center">
        ...
        <div className="flex items-center gap-2 mt-4">
          <span
            className={`text-xs font-medium px-2 py-1 rounded-[7px] ${statusConfig.color}`}
          >
            {statusConfig.label}
          </span>
          <span
            className={`text-xs font-medium px-2 py-1 rounded-[7px] ${CATEGORY_CONFIG[company.category].color}`}
          >
            {CATEGORY_CONFIG[company.category].label}
          </span>
        </div>
        ...
        <div className="flex gap-2 mt-4">
          {company.website && (
            <a
              ...
              className="flex items-center gap-2 px-3 py-2 bg-secondary text-foreground rounded-[7px] text-xs font-medium hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors"
            >
              <Globe size={12} />
              Website
            </a>
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        {company.needsAttention && company.attentionReason && (
          <div className="p-3 rounded-[7px] bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
          ...
          <div>
            ...
            <div className="space-y-2">
              {company.activeDeals.map((deal) => (
                <div
                  key={deal.id}
                  className="p-3 rounded-[7px] bg-background dark:bg-neutral-800/50 border border-border"
                >
            ...
            {companyContacts.map((contact) => {
              ...
              return (
                <div
                  ...
                  className="flex items-center gap-3 p-2 rounded-[7px] bg-background dark:bg-neutral-800/50 hover:bg-muted dark:hover:bg-neutral-800 cursor-pointer transition-colors"
                >
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-600 flex items-center justify-center text-xs font-semibold text-muted-foreground">
                    {initials}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
          ...
          <div className="space-y-2">
            {company.activities.slice(0, 6).map((activity) => {
              ...
              return (
                <div
                  key={activity.id}
                  className="flex items-start gap-3 p-2 rounded-[7px] bg-background dark:bg-neutral-800/50"
                >
                  <div className="w-7 h-7 rounded-[7px] bg-neutral-200 dark:bg-neutral-700 flex items-center justify-center shrink-0">
...
const ContactCard: React.FC<{
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-start gap-3 mb-3">
        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-600 flex items-center justify-center text-sm font-semibold text-muted-foreground shrink-0">
          {initials}
        </div>
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
  ...
  return (
    ...
    >
      ...
      <div className="p-5 border-b border-border">
        ...
        <div className="flex items-start gap-4">
          <div className="w-14 h-14 rounded-[7px] bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-600 flex items-center justify-center text-lg font-bold text-muted-foreground">
            {initials}
          </div>
          <div className="flex-1">
            <h2 className="text-lg font-semibold text-foreground">
        ...
        {/* Quick Actions */}
        <div className="flex gap-2 mt-4">
          <button className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-primary dark:bg-neutral-100 text-white dark:text-neutral-900 rounded-[7px] text-xs font-medium hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors">
            <Mail size={12} />
            Email
          </button>
          {contact.phone && (
            <button className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-secondary text-foreground rounded-[7px] text-xs font-medium hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors">
              <Phone size={12} />
              Call
            </button>
          )}
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <div
              className={`flex items-center gap-1.5 px-2 py-1 rounded-[7px] ${relationshipConfig.color}`}
            >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="shrink-0 px-6 py-4 border-b border-border">
          <div className="flex items-center justify-between mb-4">
            ...
            {/* View Toggle */}
            <div className="flex items-center gap-1 p-1 bg-muted dark:bg-neutral-800 rounded-[7px]">
              <button
                onClick={() => setViewMode("companies")}
                className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-medium transition-colors ${
                  viewMode === "companies"
                    ? "bg-card dark:bg-neutral-700 text-foreground shadow-sm"
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full h-9 pl-9 pr-4 text-sm rounded-[7px] bg-secondary border-0 placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent"
              />
            </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-2 rounded-[7px] text-xs font-medium transition-colors ${
                showNeedsAttention
                  ? "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400"
                  : "bg-secondary text-muted-foreground hover:bg-neutral-200 dark:hover:bg-neutral-700"
              }`}
            >
          ...
          <div className="flex items-center gap-2 mt-3">
            <button
              ...
              className={`px-2.5 py-1 rounded-[7px] text-[11px] font-medium transition-colors ${
                !selectedCategory
                  ? "bg-primary dark:bg-neutral-100 text-white dark:text-neutral-900"
                  : "bg-secondary text-muted-foreground hover:bg-neutral-200 dark:hover:bg-neutral-700"
              }`}
            >
              All
