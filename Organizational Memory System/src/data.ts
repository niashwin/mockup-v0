...
export const alerts: Alert[] = [
  {
    ...
    memoryRationale:
      "High probability (3 meetings, no resolution) × High impact (Q3 launch in 12 days). Escalation likely needed.",
  ...
  },
  {
    ...
    focusCategory: "friction",
    memoryRationale:
      "High probability (15% over, trending up) × High impact ($17K overage requires CFO approval). Budget action needed this week.",
    needsIntervention: true,
    needsDecision: true,
  ...
  },
  {
    ...
    focusCategory: "pulse",
    memoryRationale:
      "This surfaced because the feature directly overlaps with items on your Q2 roadmap. Market response may inform positioning.",
  ...
  },
  {
    ...
    memoryRationale:
      "This surfaced because the Feb 15 deadline is approaching and three reviews are still pending. Completing them this week keeps the renewal on track.",
    needsIntervention: true,
    needsDecision: false,
  ...
  },
  {
    ...
    focusCategory: "friction",
    memoryRationale:
      "High probability (CTO escalation, 3 weeks unresolved) × High impact ($450K ARR, renewal in 45 days). Immediate response required.",
    needsIntervention: true,
    needsDecision: true,
  ...
  },
  {
    ...
    focusCategory: "pulse",
    memoryRationale:
      "High probability (36% above baseline, customer complaints) × High impact (affects user experience). Platform team investigating.",
    needsIntervention: true,
    needsDecision: true,
...
export const commitments: Commitment[] = [
  ...
  },
  {
    ...
    focusCategory: "horizon",
    memoryRationale:
      "High probability (due today, CTO waiting) × High impact (blocks Q2 headcount decisions). Complete today.",
    needsIntervention: true,
    needsDecision: true,
  ...
  },
  {
    ...
    focusCategory: "horizon",
    memoryRationale:
      "This surfaced because it's a recurring commitment due tomorrow. The team references it during sprint planning.",
    needsIntervention: true,
    needsDecision: false,
  },
  {
    ...
    focusCategory: "friction",
    memoryRationale:
      "High probability (6 days overdue) × Medium impact (frontend team blocked on mobile). Respond to Sarah today.",
    needsIntervention: true,
    needsDecision: true,
  ...
  },
  {
    ...
    focusCategory: "horizon",
    memoryRationale:
      "This surfaced because the Feb 10 deadline is one week away and the CFO inputs haven't been gathered yet.",
    needsIntervention: true,
    needsDecision: false,
  ...
  },
  {
    ...
    focusCategory: "horizon",
    memoryRationale:
      "High probability (3 active opps at decision stage) × High impact ($83K potential NRR). Window is this week before Q2 budget locks.",
    needsIntervention: true,
    needsDecision: true,
  ...
  },
  {
    ...
    focusCategory: "horizon",
    memoryRationale:
      "High probability (SLA clock running) × High impact (enterprise customer affected). RCA due within 24 hours.",
    needsIntervention: true,
    needsDecision: false,
...
export const meetingBriefs: MeetingBrief[] = [
  ...
  },
  {
    ...
    focusCategory: "pulse",
    memoryRationale:
      "High probability (3 enterprise customers affected) × High impact (trust at risk, post-mortem imminent). Join call for visibility.",
    needsIntervention: true,
    needsDecision: true,
  ...
  },
  {
    ...
    focusCategory: "pulse",
    memoryRationale:
      "Medium probability (scheduled review) × High impact (mobile release blocked on decisions). Review prepared for you.",
    needsIntervention: true,
    needsDecision: true,
    collaborators: ["Sarah"],
    evidence: [
...
export const relationshipAlerts: RelationshipAlert[] = [
  {
    ...
    needsDecision: false,
    memoryRationale:
      "High probability (21 days since contact, she mentioned concerns) × High impact (key decision-maker for $500K contract). Relationships cool quickly after unaddressed concerns.",
    evidence: [
  ...
  },
  {
    ...
    needsDecision: false,
    memoryRationale:
      "High probability (explicit request unfulfilled for 8 days) × Medium impact (active technical evaluation). Broken promises erode trust quickly.",
    evidence: [
      {
        type: "Email",
        url: "#",
  ...
  },
  {
    ...
    needsDecision: false,
    memoryRationale:
      "Medium probability (company news creates natural touchpoint) × High impact (digital transformation = potential large deal). Timely outreach on company news shows you pay attention.",
    evidence: [
      {
        type: "News",
        url: "#",
  ...
  },
  {
    ...
    needsDecision: false,
    memoryRationale:
      "High probability (4 months without contact, commitment broken) × High impact (investor relationship, board member). Silent founders worry investors.",
    evidence: [
...
export const asyncCommitments: Commitment[] = [
  {
    ...
    needsDecision: true,
    memoryRationale:
      "High probability (due tomorrow, no draft started) × High impact ($200K deal). Email promises are easy to forget but remembered by recipients.",
  },
  {
    id: "async-2",
    ...
    needsDecision: false,
    memoryRationale:
      "High probability (2 days overdue, team waiting) × Medium impact (blocking release but not customer-facing). Slack requests get buried but team remembers.",
  ...
  },
  {
    ...
    needsDecision: true,
    memoryRationale:
      "Medium probability (2 days until due, shared doc) × Medium impact (shapes team direction). Your input matters for resource allocation.",
  },
  {
    id: "async-4",
    ...
    needsDecision: false,
    memoryRationale:
      "Medium probability (deadline approaching) × Low impact (personal reimbursement). Not urgent but easy to procrastinate.",
  },
  {
    id: "async-5",
    ...
    needsDecision: true,
    memoryRationale:
      "High probability (customer waiting, SLA risk) × High impact (Northstar is largest account). Support escalations have implicit urgency.",
