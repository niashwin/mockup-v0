...
import { Brain, Sparkles, Zap, Image, FileText, Link, Hash, User } from 'lucide-react';
...
export const MemoryBubbles: React.FC<MemoryBubblesProps> = ({ onBubbleClick }) => {
  ...
  const bubbles: Bubble[] = [
    // Center Core
    { id: 1, label: 'Vision', size: 'xl', x: 50, y: 50, gradient: 'from-fuchsia-500/20 to-purple-600/20 text-fuchsia-900 dark:text-fuchsia-100 ring-fuchsia-500/30', icon: Brain, delay: 0 },
    
    // Top Right - Strategy
    { id: 2, label: 'Q3 Goals', size: 'lg', x: 75, y: 25, gradient: 'from-blue-500/20 to-cyan-500/20 text-blue-900 dark:text-blue-100 ring-blue-500/30', icon: Zap, delay: 0.1 },
    { id: 3, label: 'Growth', size: 'sm', x: 85, y: 15, gradient: 'from-blue-400/10 to-blue-500/10 text-blue-800 dark:text-blue-200 ring-blue-400/20', delay: 0.2 },
    
    // Bottom Right - Product
    { id: 4, label: 'Mobile App', size: 'lg', x: 70, y: 70, gradient: 'from-emerald-500/20 to-teal-500/20 text-emerald-900 dark:text-emerald-100 ring-emerald-500/30', icon: FileText, delay: 0.15 },
    { id: 5, label: 'Beta', size: 'md', x: 82, y: 80, gradient: 'from-emerald-400/10 to-teal-400/10 text-emerald-800 dark:text-emerald-200 ring-emerald-400/20', icon: Hash, delay: 0.25 },
    
    // Bottom Left - Research
    { id: 6, label: 'User Study', size: 'lg', x: 25, y: 75, gradient: 'from-amber-500/20 to-orange-500/20 text-amber-900 dark:text-amber-100 ring-amber-500/30', icon: User, delay: 0.1 },
    { id: 7, label: 'Feedback', size: 'sm', x: 15, y: 85, gradient: 'from-amber-400/10 to-orange-400/10 text-amber-800 dark:text-amber-200 ring-amber-400/20', delay: 0.3 },
    { id: 8, label: 'Survey', size: 'xs', x: 35, y: 88, gradient: 'from-amber-300/10 to-orange-300/10 text-amber-800 dark:text-amber-200 ring-amber-300/20', delay: 0.4 },

    // Top Left - Design
    { id: 9, label: 'Design Sys', size: 'md', x: 25, y: 30, gradient: 'from-pink-500/20 to-rose-500/20 text-pink-900 dark:text-pink-100 ring-pink-500/30', icon: Image, delay: 0.2 },
    { id: 10, label: 'Icons', size: 'xs', x: 15, y: 20, gradient: 'from-pink-400/10 to-rose-400/10 text-pink-800 dark:text-pink-200 ring-pink-400/20', delay: 0.35 },
    
    // Floating Connectors
    { id: 11, label: 'API', size: 'sm', x: 60, y: 40, gradient: 'from-zinc-500/10 to-zinc-600/10 text-zinc-700 dark:text-zinc-300 ring-zinc-500/20', icon: Link, delay: 0.5 },
    { id: 12, label: 'Docs', size: 'xs', x: 40, y: 60, gradient: 'from-zinc-500/10 to-zinc-600/10 text-zinc-700 dark:text-zinc-300 ring-zinc-500/20', delay: 0.55 },
    { id: 13, label: 'Sarah', size: 'sm', x: 45, y: 20, gradient: 'from-violet-500/10 to-purple-500/10 text-violet-800 dark:text-violet-200 ring-violet-500/20', icon: User, delay: 0.6 },
  ];

  const connections = [
    [1, 2], [1, 4], [1, 6], [1, 9], // Core radiation
    [2, 3], // Strategy cluster
    [4, 5], [4, 11], // Product cluster
    [6, 7], [6, 8], // Research cluster
    [9, 10], [9, 13], // Design cluster
    [11, 2], // Cross links
    [12, 6],
  ];
