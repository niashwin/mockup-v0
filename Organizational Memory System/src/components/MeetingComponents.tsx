...
export const MeetingDetailCard = ({
  ...
  return (
    ...
    >
      ...
      {!isHero && !isPrivate && (
        <div className="absolute top-0 right-0 w-48 h-48 bg-zinc-200/20 dark:bg-zinc-800/20 rounded-full blur-[60px] -mr-10 -mt-10 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity" />
      )}
      {isPrivate && (
        <div className="absolute top-0 right-0 w-48 h-48 bg-orange-500/10 rounded-full blur-[60px] -mr-10 -mt-10 pointer-events-none" />
      )}
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            {meeting.attendees.map((att, i) => (
              <div
                key={i}
                className="flex items-center gap-1.5 pl-1 pr-2 py-0.5 rounded-full bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-800 text-[10px] font-medium text-zinc-600 dark:text-zinc-400"
              >
