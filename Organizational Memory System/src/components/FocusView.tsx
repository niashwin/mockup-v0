...
function getNextStepActions(item: AttentionItem): Array<{
  id: string;
  label: string;
            ...
            {item.itemType === "meeting" ? (
              <>
                ...
                {item.preMeetingBrief && (
                  <div>
                    <h2 className="text-xs font-bold uppercase tracking-wider text-zinc-500 mb-1.5">
                      Meeting Context
                    </h2>
              ...
              <>
                {/* Context - for attention items only */}
                <div>
                  <h2 className="text-xs font-bold uppercase tracking-wider text-zinc-500 mb-1.5">
                    Context
                  </h2>
                ...
                {/* Why this surfaced - for attention items only */}
            ...
            <div className="flex items-center justify-end gap-2">
              {item.itemType === "meeting" ? (
                ...
                <>
                  ...
                  {/* Snooze - only for attention items */}
                  <button
