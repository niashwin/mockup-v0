        ...
        <div className="space-y-1.5">
          ...
          <div className="flex justify-end gap-1">
            <button
              ...
              className="px-2 py-0.5 text-[10px] text-zinc-500 hover:text-zinc-700"
            >
              Cancel
            </button>
            <button
              onClick={saveEdit}
              className="px-2 py-0.5 text-[10px] bg-emerald-500 text-white rounded"
            >
              Save
            </button>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end gap-1.5">
        <button
          onClick={onCancel}
          className="px-2.5 py-1 text-[11px] text-zinc-500 hover:text-zinc-700"
        >
          Cancel
        </button>
        <button
